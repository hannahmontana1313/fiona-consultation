        ...
        <div className="card fade-up" style={{ overflow: 'hidden' }}>
          ...
          <div style={{ padding: '2rem' }}>
            ...
            <div style={{
              ...
              ⚠️ {tirage === 'true' ? 'Tu seras redirigée vers le tirage automatiquement.' : 'Ton accès au chat sera activé manuellement dès réception du paiement. Cela prend généralement 2 à 5 minutes pendant mes heures de disponibilité.'}
            </div>
